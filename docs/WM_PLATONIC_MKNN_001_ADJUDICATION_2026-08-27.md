...
3. Seed **137** confirmation latent MSE exploded (`≈1.38e16`) while
   neighborhood overlap remained high. That is a numerical diagnostic of
   the linear decoder on this map/seed; it is **not** a reason to retune
   k, maps, or gates.
