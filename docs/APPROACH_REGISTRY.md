...
| Workspace discovery | root agent | Can a compact shared causal subspace be distinguished from private channels and PCA? | Detector controls pass; tiny JEPA candidate fails uncertainty validity and PCA specificity. | Full task control/reuse remains absent. | Run preregistered deep-ensemble study with conditional donor controls. | `ACTIVE` |
