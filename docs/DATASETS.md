...
| PixelTinyMaze | local deterministic renderer over TinyMaze | MIT code, generated data | 3-channel pixels/state/one-hot action | pixels 3x20x20, state 5, action 4 | disjoint seeds 83/89/97 | none claimed in v1 | `gpu_12gb` | source-informed small LeWorldModel and circuit audit | trajectory or goal leakage | `SMOKE_VALIDATED` |
