...
action-path result is labeled calibration; adversarial review found that its stored quantities and
sampling cannot repair the shared-denominator confound, so the route is closed without protected
test access.
...
All 24 required entries and 27 supplemental adversarial/prior-art entries were checked against
