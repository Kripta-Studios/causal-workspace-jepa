...
but remains random-weight engineering evidence.  The next discriminating studies
should use a precisely replayed Qwen treatment to compare module mediator rankings
and reproduce the competent official EB-JEPA planner before auditing recurrent
action routes.  Only an eligible causal dataset from
