...
independent action-space check.  A clean integration smoke and a frozen
32-seed post-discovery CEM/MPPI confirmation are preregistered but not yet
reported as retained results.  Planning competence and later circuit tests
...
\begin{itemize}[leftmargin=*]
  ...
  exploratory MPPI action exceeded its configured norm; both clean diagnostics
  are pending at the time of this draft.
